              ...
              Expanded(
                child: ListAnimator(
                  data: [
                        ...
                        Hero(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(fit: BoxFit.cover, image: NetworkImage(post.book!.image!)),
                            ),
                          ),
                        ),
                      ],
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: NetworkImage(post.book!.owner!.image!), fit: BoxFit.contain),
                              ),
                            ),
                            SizedBox(width: 8),
                            Text(
                              post.book!.owner!.name!,
                              style: AppTextStyles.w400.copyWith(fontSize: 18, color: AppColor.SUB_HEADER),
                            ),
                          ],
                        ),
                      ],
                    ...
                    Text(post.book!.describtion!,style: AppTextStyles.w400.copyWith(fontSize: 24),)
                  ],
                ),
              ),
              Row(
                children: [
                  Expanded(child: CustomBtn(icon: Icons.check,text: "Request", onTap: (){},fontSize: 24,)),
                  SizedBox(width: 16),
                  Expanded(child: CustomBtn(icon: Icons.message_rounded,text: "Comment", onTap: (){},fontSize: 24,))
                ],
              )
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          value,
          style: AppTextStyles.w600.copyWith(fontSize: 18, color: AppColor.HEADER),
        )
      ],
    );
  }
