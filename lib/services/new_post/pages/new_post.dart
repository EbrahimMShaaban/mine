                      ...
                      data: [
                        StreamBuilder<String?>(
                            ...
                            builder: (context, snapshot) {
                              return CustomTextField(hint: 'Bool Tilte', onChange: NewPostBloc.instance.updateBookName, hasError: snapshot.hasError, initText: NewPostBloc.instance.bookName.valueOrNull);
                            }),
                        StreamBuilder<CustomModelSheet?>(
                            stream: NewPostBloc.instance.bookCategoryStream,
                            builder: (context, snapshot) {
                              return FormSelector(
                                data: [CustomModelSheet(name: "Romantic", value: "Romantic"), CustomModelSheet(name: "Advanture", value: "Advanture")],
